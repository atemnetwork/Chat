...
import { getExplorer } from "../components/helpers/networks";
// import AddressInput from "./AddressInput";
import { useVerifyMetadata } from "../components/hooks/useVerifyMetadata";
...
function NFTBalance() {
  ...
  return (
    <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" }}>
      <h1 style={{textAlign: 'center'}}>List NFTs</h1>
